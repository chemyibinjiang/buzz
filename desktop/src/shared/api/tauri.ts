  ...
  const response = await invokeTauri<RawCreateManagedAgentResponse>(
    "create_managed_agent",
    {
      input: {
        ...
        codexSshHost: input.codexSshHost,
        codexSshPort: input.codexSshPort,
        codexSshUsername: input.codexSshUsername,
        codexSshIdentityFile: input.codexSshIdentityFile,
        codexSshRemoteAppServerPort: input.codexSshRemoteAppServerPort,
        codexSshRemoteShell: input.codexSshRemoteShell,
        codexTaskName: input.codexTaskName,
        codexTaskWorkspace: input.codexTaskWorkspace,
